      ...
      <div className="dashboard">
        ...
        <aside className="aside-proyectos">
          ...
          <form onSubmit={handleAgregar}>
            <div className="form">
              <input type="text" id="nombreProyecto" name="nombreProyecto" value={form.nombreProyecto} onChange={(e) => handleInputChange(e)} placeholder="Nombre del proyecto" required />
              <input type="text" id="categoriaProyecto" name="categoriaProyecto" value={form.categoriaProyecto} onChange={(e) => handleInputChange(e)} placeholder="Categoría" required />
              <input type="text" id="equipoProyecto" name="equipoProyecto" value={form.equipoProyecto} onChange={(e) => handleInputChange(e)} placeholder="Equipo a cargo" required />
              <input type="text" id="rolProyecto" name="rolProyecto" value={form.rolProyecto} onChange={(e) => handleInputChange(e)} placeholder="Rol" required />
              <select id="estadoProyecto" name="estadoProyecto" value={form.estadoProyecto} onChange={(e) => handleInputChange(e)} required>
                <option value="">Selecciona un estado</option>
                <option value="En curso">En curso</option>
                <option value="Finalizado">Finalizado</option>
                <option value="Pendiente">Pendiente</option>
              </select>
              <textarea id="descripcionProyecto" name="descripcionProyecto" value={form.descripcionProyecto} onChange={handleInputChange} placeholder="Descripción del proyecto" rows={4} required />
